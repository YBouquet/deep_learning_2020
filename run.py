...
(train_set_figures, train_target_figures,
 ...
 test_set_first_figures, test_set_second_figures, test_target_comparison) = functions.formatting_input(PAIRS_NB)
...
for (model, name_model, eta_model) in models:
    ...
    functions.print_error(name_model, 'train recognition', nb_train_recognition_errors, train_set_figures.size(0))
    ...
    functions.print_error(name_model, 'test recognition', nb_test_recognition_errors, test_set_figures.size(0))
    ...
    functions.print_error(name_model, 'test comparison', nb_test_comparison_errors, test_target_comparison.size(0))
    print('\n')
