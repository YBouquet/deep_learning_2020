...
parser.add_argument('--n_epochs_pr', type=int, default=25, help = 'Number of epochs')
...
parser.add_argument('--learning_rate_pr', type = float, default = 1e-3)
...
parser.add_argument('--adam_beta1_pr', type = float, default = 0.9)
